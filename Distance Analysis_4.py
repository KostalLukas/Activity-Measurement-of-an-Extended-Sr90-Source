# -*- coding: utf-8 -*-
"""
Radioactivity Distance Analysis v4.1
...
# count rate and associated error in Bq
f = n / t - fb
...
plt.savefig(f'Plots/{dataset}_fit.png', dpi=300, bbox_inches='tight')
plt.show()
...
data_theoretical = np.loadtxt(f'Output/extended.csv', unpack=True, delimiter=',', skiprows=1)
